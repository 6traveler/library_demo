...
public class FndBookUI extends JFrame {
	...
	public FndBookUI() {
		...
		JLabel label3 = new JLabel("价格上界：");
		label3.setBounds(86, 92, 70, 16);
		panel3.add(label3);
		JLabel label4 = new JLabel("价格下界：");
		...
		yesbutton3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Operator operator = new Operator();
				if(Float.parseFloat(lowBound)>Float.parseFloat(upBound)){
					JOptionPane.showMessageDialog(null, "失败，请检查输入！");
					FndBookUI.this.dispose();
				}
